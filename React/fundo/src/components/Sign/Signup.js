  ...
  return (
    <div>
        <Container maxWidth="lg">
            <Grid container style={{padding:'30px',border:'1px solid #dadce0',margin:'50px 0',borderRadius:'8px'}}>
                    ...
                    <Grid container justifyContent="flex-start" alignItems="flex-start">
                        ...
                        <Grid item xs={12} md={10}>
                            ...
                            <Grid container>
                                ...
                                <Grid item>
                                    <h5>You can use letters,numbers, & symbols</h5>
                                </Grid>
                            </Grid>
                            <Grid container>
                                <Grid item style={{display:'flex'}}>
                                    ...
                                    <Grid item xs={12} md={6} marginLeft={'15px'}>
                                        <TextField id="outlined-basic" label="Confirm" variant="outlined" 
                                        fullWidth
                                        type={showPassword? 'text': 'password'}
                                        />
                                    </Grid>
                                    <Button variant='text' style={{color:'black'}} onClick={handlePasswordVisibility}>
                                        <VisibilityOffIcon/>
                                    </Button>
                                </Grid>
                                <Grid item>
                ...
                <Grid item xs={12} md={4} className='Grid-image'>
                    <img src={Google} alt="" style={{ width: '100%', height: '100%',objectFit:'cover'}}/>
                </Grid>
            </Grid>
        </Container>
    </div>
