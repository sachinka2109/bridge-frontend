  ...
  return (
    <form onSubmit={handleSubmit}>
      <Container maxWidth="sm">
          <Grid container sx={{padding:{xs:0,sm:'50px'},margin:'50px 0',border:{xs:0,sm:'1px solid #dadce0'},borderRadius:'8px',display:'flex',flexDirection:'column'}}>
              <Grid item padding={'10px 0px'} sx={{margin:{xs:'0',sm:'0 30px'}}}>
                  ...
                  <h3 style={{margin:'0',fontSize:'20px'}}>Forgot Password?</h3>
                  <h5 color='#dadce0' style={{margin:'10px 0',fontSize:'16px'}}>Enter Your Email</h5>
              </Grid>
              ...
              <Grid container sx={{marginBottom:'30px',padding:{xs:'10px 0px',sm:'30px'},justifyContent:'space-between'}}  >        
                  <Grid item>
                    <Link to='/'>
                      <Button variant="text" type='submit' style={{textTransform: 'none'}}>Signin instead</Button>
                    </Link>
                  </Grid>        
                  <Grid item>
                      <Button variant="contained" type='submit' style={{textTransform: 'none'}}>Submit</Button>
                  </Grid>
              </Grid>
          </Grid>
      </Container>
