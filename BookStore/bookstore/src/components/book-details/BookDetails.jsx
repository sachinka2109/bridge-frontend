            ...
            <Grid item sx={{display:'flex',flexDirection:'column',mx:5}}>
                ...
                {location.includes('admin') ? (
                    <Box sx={{display:'flex',justifyContent:'space-between',alignItems:'center',my:3}}>
                            <Button variant='contained' sx={{flexGrow:1,marginRight:'20px',backgroundColor:'#A03037','&:hover':{backgroundColor:'#A03037'}}}>Edit</Button>
                            <Box item sx={{display:'flex',alignItems:'center',flexGrow:1}}>
                                <Button variant='contained' sx={{flexGrow:1,marginRight:'20px',backgroundColor:'#A03037','&:hover':{backgroundColor:'#A03037'}}}>Update</Button>
                            </Box>
